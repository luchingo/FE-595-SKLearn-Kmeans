...
plt.subplot(3, 2, 1)
plt.scatter(iris_x.iloc[:, [0]], iris_x.iloc[:, [1]], c=kmeans_fin.labels_, cmap="rainbow")
plt.title(''.join([iris_x.columns[0], " vs ", iris_x.columns[1]]))

plt.subplot(3, 2, 2)
plt.scatter(iris_x.iloc[:, [0]], iris_x.iloc[:, [2]], c=kmeans_fin.labels_, cmap="rainbow")
plt.title(''.join([iris_x.columns[0], " vs ", iris_x.columns[2]]))

plt.subplot(3, 2, 3)
plt.scatter(iris_x.iloc[:, [0]], iris_x.iloc[:, [3]], c=kmeans_fin.labels_, cmap="rainbow")
plt.title(''.join([iris_x.columns[0], " vs ", iris_x.columns[3]]))

plt.subplot(3, 2, 4)
plt.scatter(iris_x.iloc[:, [1]], iris_x.iloc[:, [2]], c=kmeans_fin.labels_, cmap="rainbow")
plt.title(''.join([iris_x.columns[1], " vs ", iris_x.columns[2]]))

plt.subplot(3, 2, 5)
plt.scatter(iris_x.iloc[:, [1]], iris_x.iloc[:, [3]], c=kmeans_fin.labels_, cmap="rainbow")
plt.title(''.join([iris_x.columns[1], " vs ", iris_x.columns[3]]))

plt.subplot(3, 2, 6)
plt.scatter(iris_x.iloc[:, [2]], iris_x.iloc[:, [3]], c=kmeans_fin.labels_, cmap="rainbow")
